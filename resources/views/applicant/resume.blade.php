...
@section('applicant.resume', 'active')
                                ...
                                <form action="{{ route('applicant.resume.store') }}" method="post" >
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mt-3">
                                            <button type="submit" class="btn btn-primary">Save</button>
                                            <a href="{{ route('applicant.emp_hist.delete', $emp_hist->id) }}" class="btn btn-danger pull-right" style="float: right">Delete</a>
                                        </div>
                                    </div>
                                </form>
                            </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="traveling">
                                                @if ($data)
                                                    <option value="yes" {{$data->traveling == 'yes' ? 'selected': ''}}>Yes</option>
                                                    <option value="conditional" {{$data->traveling == 'conditional' ? 'selected': ''}}>Conditional</option>
                                                    <option value="no" {{$data->traveling == 'no' ? 'selected': ''}}>No</option>
                                                @else
                                ...
                                <form action="{{ route('applicant.resume.store') }}" method="post">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group mt-3">
                                            ...
                                            <a href="{{ route('applicant.edu_hist.delete', $edu_hist->id) }}" class="btn btn-danger pull-right" style="float: right">Delete</a>
                                        </div>
                                    </div>
                              </form>
                            </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="form-group" data-select2-id="55">
                                        ...
                                        <select name="language" class="select3 select2-hidden-accessible"  data-placeholder="Select Language" data-value="" style="width: 100%;" data-select2-id="1" tabindex="-1" aria-hidden="true" required>
                            ...
                            <div class="card add_lang">
                                ...
                                <div class="card-body">
                                    <form action="{{ route('applicant.resume.store') }}" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group mt-3">
                                            <button type="submit" class="btn btn-primary">Save</button>
                                            <a href="{{ route('applicant.add_lang.delete', $add_lang->id) }}" class="btn btn-danger pull-right" style="float: right">Delete</a>
                                        </div>
                                    </form>
                                </div>
                            </div>
...
<script>
    ...
    $(document).on('click', '.addfield', function(e) {
        ...
        let html = '';
            html += '<div class="card customer_records"><form action="{{ route('applicant.resume.store') }}" method="post" >@csrf<input type="hidden" name="part" value="em_hist" /><div class="card-header"><h5>Employment history</h5></div><div class="card-body">';
...
<script>
    ...
    $(document).on('click', '.addfieldedu', function(e) {
        ...
        let html = '';
            ...
            html += '<form action="{{ route('applicant.resume.store') }}" method="post">@csrf<input type="hidden" name="part" value="edu_hist" />';
...
<script>
    ...
    $(document).on('click', '.addfieldlang', function(e) {
        let html = '';
            html += '<div class="card add_lang"><div class="card-header"><h5>Additional Language Skills</h5></div><div class="card-body"><form action="{{ route('applicant.resume.store') }}" method="post" enctype="multipart/form-data">@csrf<div class="form-group" ata-select2-id="56">';
