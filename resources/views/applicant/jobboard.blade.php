...
@section('applicant.jobboard', 'active')
@push('header_script')
<style>
    ul {
        list-style: none;
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <form action=" {{ route('applicant.jobboard') }} ">
                <div class="row no-gutters">
                    ...
                    <div class="col-md-5 col-lg-3">
                        ...
                        <a href=" {{route('applicant.jobboard')}} " class="btn btn-outline-dark">Clear filters</a>
                    </div>
                ...
                <div class="modal-dialog modal-md">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action=" {{ route('applicant.jobboard.subscribe') }} " method="post">
                                @csrf
                                <div class="form-group">
                                    <label>search</label>
            ...
            <div class="row mt-5">
                    ...
                    <div class="category-sidebar position-sticky">
                        <div class="card mb-3">
                            ...
                            <div class="card-body search-form">
                                <form action="{{ route('applicant.jobboard') }}" method="get">
                            ...
                            <div class="card-body">
                                <div class="sidebar-list category-list">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('applicant.jobboard', ['category' => $category->url_slug]) }}"><i class="fa fa-angle-right"></i> {{ $category->name }}
                            ...
                            <div class="card-body">
                                <div class="sidebar-list industry-list">
                                    <ul>
                                        ...
                                        <li>
                                            <a href="{{ route('applicant.jobboard', ['industry' => $industry]) }}">{{ $industry }}
                            ...
                            <div class="card-body">
                                <div class="sidebar-list location-list">
                                    <ul>
                                        @foreach($data['locations'] as $location)
                                        <li>
                                            <a href="{{ route('applicant.jobboard', ['location' => $location->url_slug]) }}">{{ $location->name }}
                ...
                <div class="col-sm-9">
                    <div class="card">
                        <div class="card-header">
                            <h5>Job Board</h5>
                            <span style="float: right">Total job found ({{count($data['jobs'])}}) <a href=" {{ route('applicant.jobboard') }} ">View All</a></span>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @if(isset($data['jobs']) && count($data['jobs']))
                                       ...
                                       <tr>
                                           ...
                                           <td>
                                               @php
                                                    $application = \DB::table('applications')->where('applications.applicant_id', Auth::user()->id)->where('job_id', $job->id)->count();
                                               @endphp
                                            {{-- <a href="{{ route('details', $job->id) }}" class="btn-sm btn-primary">Apply</a> --}}
