                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="float-right">
                                    <a href="{{ route('recruiter.organization_add') }}" class=" btn btn-success" >@lang('web.add_new')</a>
                                </div>
                            </div>
                            <div class="card-body">
                                ...
                                <table class="table responsive table-bordered" id="datatable1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $item->street }}</td>
                                            <td>
                                                <a href=" {{ route('recruiter.organization.edit', $item->id) }} " class="btn-sm btn-warning"><i class="fa fa-pencil-alt"></i></a>
                                                <a onclick="return confirm('Are you really sure to delete ?')" href=" {{ route('recruiter.organization.delete', $item->id) }} " class="btn-sm btn-danger"><i class="fa fa-trash"></i></a>
                                            </td>
                                        </tr>
                                        @endforeach
