...
@section('recruiter.email_templates', 'active')
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0">@lang('web.email') @lang('web.notifications')</h1>
                    </div>
                    <!-- /.col -->
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href=" {{ route('recruiter_dashboard') }} ">@lang('web.home')</a></li>
                            <li class="breadcrumb-item active">@lang('web.email') @lang('web.notifications')</li>
                        </ol>
                    </div>
                    <!-- /.col -->
                </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="card-header">
                                <h5>@lang('web.email') @lang('web.notifications')</h5>
                            </div>
                            <div class="card-body">
                                ...
                                @endif
                                <form action="{{ !blank($usermail) ? route('recruiter.email_templates.edit',$usermail->id) : route('recruiter.email_templates.store') }}" method="post">
                                    @csrf
                                    <div class="card-body">
                                ...
                                <form action="{{ route('recruiter.customize.form') }}" method="POST" >
                                    @csrf
                                ...
                                @else
                                <form action="{{ route('recruiter.customize.form.edit',$customizeForm->id) }}" method="POST" >
                                    @csrf
                                    <div class="card-footer">
                                        <div class="text-center mb-3">
                                            <h4>Customize application form</h4>
