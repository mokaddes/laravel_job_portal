            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <div class="float-left btn btn-success">Industry List</div>
                            ...
                            <table id="datatable1" class="table display responsive nowrap text-center">
                              ...
                              <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> {{ $industry->name }} </td>
                                    <td>
                                        <form action="{{ route('industry.destroy', $industry->id) }}" method="POST" id="form">


                                            <a class="btn btn-primary" href="{{ route('industry.edit', $industry->id) }}">Edit</a>

                                            @csrf
                                            @method('DELETE')

                                            <a href=" {{ route('industry.delete', $industry->id) }} " class="btn btn-danger" id="delete">Delete</a>
                              ...
                              <form action=" {{ route('industry.store') }} " method="post">
                                  <div class="modal-body pd-20">
                                      ...
                                      <div class="form-group">
                                          <label for="name" class="control-label">industry Name</label>
