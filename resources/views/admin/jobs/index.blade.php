...
@section('admin.admin_jobs', 'active')
...
{{--                            <a href=" {{ route('adminjobs.index') }} " class="btn btn-primary">@lang('web.clear_filters')</a>--}}
{{--                        </div>--}}
{{--                    </div>--}}
{{--                </form>--}}
                        ...
                        <form class="form-inline d-none d-sm-inline-block">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a href=" {{ route('adminjobs.index') }} " class="btn btn-outline-success {{ $status == 1 ? 'active' : '' }}">@lang('web.show_all_job')</a>
                                </div>
                            </div>
                        </form>
...
{{--                            <div class="input-group">--}}
{{--                                <div class="input-group-append">--}}
{{--                                    <a href=" {{ route('adminjobs.index') }}?status=my_jobs" class="btn btn-outline-primary  {{ $status == 'my_jobs' ? 'active' : '' }}">@lang('web.show_my_job')</a>--}}
...
{{--                        </form>--}}
                        ...
                        <form class="form-inline d-none d-sm-inline-block">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a href=" {{ route('adminjobs.index') }}?status=active" class="btn btn-outline-info {{ $status == 'active' ? 'active' : '' }} ">@lang('web.active')</a>
                        ...
                        <form class="form-inline d-none d-sm-inline-block">
                            <div class="input-group">
                                ...
                                <div class="input-group-append">
                                    <a href=" {{ route('adminjobs.index') }}?status=inactive" class="btn btn-outline-danger {{ $status == 'inactive' ? 'active' : '' }}">@lang('web.inactive')</a>
                        ...
                        <form class="form-inline d-none d-sm-inline-block">
                            <div class="input-group">
                                <div class="input-group-append">
                                    <a href=" {{ route('adminjobs.index') }}?status=draft" class="btn btn-outline-primary  {{ $status == 'draft' ? 'active' : '' }}">Draft Job</a>
                                </div>
                            </div>
                        </form>
