...
@section('admin.jobs_create', 'active')
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="{{ route('admin.jobs') }}">@lang('web.jobs')</a></li>
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                <div class="col-md-8">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.jobs_store') }}{{ isset($data['job']->id) ? '?jobid=' . $data['job']->id : '' }}" id="form1" method="post">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.jobs_store') }}{{ isset($data['job']->id) ? '?jobid=' . $data['job']->id : '' }}" id="form2" method="post">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.jobs_store') }}{{ isset($data['job']->id) ? '?jobid=' . $data['job']->id : '' }}" id="form3" method="post">
                                                                <div class="form-group">
                                                                    <label>Salary</label>
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.jobs_store') }}{{ isset($data['job']->id) ? '?jobid=' . $data['job']->id : '' }}" id="form4" method="post">
                                                                <div class="form-group">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body active_label">
                                                            ...
                                                            <form action="{{ route('admin.jobs_store') }}{{ isset($data['job']->id) ? '?jobid=' . $data['job']->id : '' }}" id="form5" method="POST">
                                                                @csrf
                                                                <div class="row">
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.jobs_store') }}{{ isset($data['job']->id) ? '?jobid=' . $data['job']->id : '' }}" method="POST" id="form6">
                                                                @csrf
                                                    ...
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.jobs_store') }}{{ isset($data['job']->id) ? '?jobid=' . $data['job']->id : '' }}" method="POST" id="form7">
                                                                @csrf
                                            ...
                                            <div class="row d-flex justify-content-center">
                                                <div class="col-md-8">
                                                    <div class="card">
                                                        ...
                                                        <div class="card-body">
                                                            <form action="{{ route('admin.jobs_store.invoice') }}" id="form7" method="post">
                                                                @csrf
