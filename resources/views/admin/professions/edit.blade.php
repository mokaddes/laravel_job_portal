            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-header">
                        <div class="float-left btn btn-success">Profission Edit</div>
                        <div class="float-right">
                            <a href=" {{ route('professions.index') }} " class=" btn btn-success">>Back</a>
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="col-md-10 container-fluid" style="margin-top:20px">
                            <form action=" {{ route('professions.update', $profession->id) }} " method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" id="name" class="form-control" value="{{$profession->name}}">
                                    @if ($errors->has('name'))
